      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            } catch { /* proceed to clear locally regardless */ }
...
const styles = StyleSheet.create({
  ...
  tile: { backgroundColor: METRO.surface, padding: 18, marginBottom: 20 },
  tileTitle: { color: '#fff', fontSize: 15, fontWeight: '600' },
  dangerTile: { backgroundColor: 'rgba(239,68,68,0.12)', borderWidth: 1, borderColor: 'rgba(239,68,68,0.3)', padding: 18, marginBottom: 20 },
